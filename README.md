...
This repository contains the worked sample app for the [Grails + @Scheduled](https://grails.apache.org/guides/grails-scheduled/4/guide/index.html) guide on the Apache Grails site.
